...
namespace SUDOKU
{
    public partial class SudokuForm : Form
    {
        ...
        private void BNewgame_Click(object sender, EventArgs e)//кнопка Новая игра
        {
            ...
            form.ShowDialog();
            int diff = form.diff;
            //startVals = DEBUG_ONLY;//!!!Тут, вместо DEBUG_ONLY, сгенерировать стартовые значения в виде массива структуры StartingValue и вставить в экземпляр массива "startVals" в зависимости от сложности diff. 
